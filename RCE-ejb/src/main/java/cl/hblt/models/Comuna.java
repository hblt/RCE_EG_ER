...
@NamedQueries({
  ...
  @NamedQuery(name = "Comuna.findByComuAbrev", query = "SELECT c FROM Comuna c WHERE c.comuAbrev = :comuAbrev")})
public class Comuna implements Serializable {
  ...
  @Size(max = 10)
  @Column(name = "comu_abrev")
  private String comuAbrev;
  ...
  public String getComuAbrev() {
    return comuAbrev;
  }

  public void setComuAbrev(String comuAbrev) {
    this.comuAbrev = comuAbrev;
  }
  ...
  public String toString() {
    return "cl.hblt.models.Comuna[ idComuna=" + idComuna + " ]";
  }
